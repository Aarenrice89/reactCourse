...
export default class Checkout extends React.Component {
  // constructor(props) {
  //   super(props);
  //   // Class states are declared as a single object
  //   // Equivalent
  //   this.state = {
  ...
  // Equivalent to code ^ above, declaring a state field
  state = {
    address: emptyAddress,
    status: STATUS.IDLE,
    saveError: null,
  ...
  handleBlur = (event) => {
    event.persist();
    this.setState((state) => {
      // Update the state for touched. Set it to a copy of the current value
      // for touched, but set an extra property based on the id passed in
